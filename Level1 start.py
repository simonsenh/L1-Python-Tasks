...
print("THIS PIECE OF WORK ALSO HAS NO NAME AND NO PURPOSE")
skin = 10
weapon = 10
vbucks = 15
giftcard_henry = 50
...
print("Henry spent {} on a skin, {} on a weapon and {} on some vbucks in fortnight".format(skin, weapon, vbucks))
print("Henry has {} on his gift card".format(giftcard_henry))
